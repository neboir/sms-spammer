...
\033[0m
\033[0m
           \033[33m    tool bởi hacker lỏ \033[0m
           \033[33m     TELEGRAM: t.me/@itsme_lord \033[0m
            \033[33m     BỐ M CHẤP HẾT❗ \033[0m
"""
for i in ban:
    sys.stdout.write(i)
    sys.stdout.flush()
...
first_names = ['Nam', 'Tuấn', 'Hương', 'Linh', 'Long', 'Duy','Đức','Hiệp']
...
if __name__ == "__main__":
    ...
    print("Đang chuẩn bị chạy xin chờ vài giây.....")
    os.system('color a')
    for g in range(10,0,-1):
        print(f"\r Bắt đầu chạy trong vòng ",g,end=" ",flush=True)
        time.sleep(1)
    print("\r" + " " * 20, end="", flush=True)
    print(f"\r START HIJACKING")
    for i in range(1, count + 1):
        LJJJJLJIJLLJLJILJLIILLIIL(phone, i)
        os.system("ping -n 1 google.com >nul")
    os.system('cls')
    print("OK DONE DONATE ME 2321012007 TECHCOMBANK ❤️")
